...
#define STEM_TAG "StemMixer"
#define STEM_LOGI(...) __android_log_print(ANDROID_LOG_INFO, STEM_TAG, __VA_ARGS__)
#define STEM_LOGE(...) __android_log_print(ANDROID_LOG_ERROR, STEM_TAG, __VA_ARGS__)
