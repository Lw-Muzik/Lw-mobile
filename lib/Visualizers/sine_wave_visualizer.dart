...
class HeartbeatVisualizer extends CustomPainter {
  ...
  HeartbeatVisualizer({required this.audioData, required this.time});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final baseColor = Color.lerp(Colors.red[300], Colors.red[700], intensity)!;
    ...
    for (double x = 0; x < width; x += 1) {
      ...
      final baseY =
          sin((x * beatFrequency * 2 * pi / width) + time * 0.02) *
          beatAmplitude *
          0.3;
