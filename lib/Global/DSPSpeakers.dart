              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      controller.dspSpeakerView ? "Grid View" : "List View",
                ...
                IconButton(
                  onPressed: () {
                    controller.dspSpeakerView = !controller.dspSpeakerView;
                  },
                  icon: Icon(
                            ...
                            ...List.generate(
                              ...
                              (index) => InkWell(
                                onTap: () {
                                  ...
                                  Routes.pop(context);
                                  controller.spkName = SPEAKERS[index].name;
                                },
                                child: GridTile(
                                  child: Card(
                          ...
                          children: [
                            ...List.generate(
                              ...
                              (index) => RadioListTile(
                                ...
                                value: widget.controller.selectSpeaker == index
                                    ? 1
                                    : 0,
                                groupValue: 1,
                                onChanged: (value) {
