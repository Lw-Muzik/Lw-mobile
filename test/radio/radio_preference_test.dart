...
/// The smallest thing that is a station, for tests that only care that one is
/// attached.
class _Seed implements StationSource {
  _Seed(this.seedKey);
  @override
  final String seedKey;
  @override
  String get kind => 'seed';
  @override
